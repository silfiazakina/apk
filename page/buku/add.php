            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="penerbit" name="penerbit" type="text" class="form-control" placeholder="Masukkan Nama Penerbit" required>
                    </div>
                    <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    try {
        $pdo = Koneksi::connect(); // Pastikan nama kelas dan metode sesuai
